      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
					...
					<div class="col-8 col-sm-5 col-md-5 col-lg-6">
						{!! Form::label('razonsocial', 'Razon Social o RUC:') !!}
						{!! Form::text('razonsocial', '', array('class' => 'form-control input-xs', 'id' => 'razonsocial')) !!}
					</div>
					...
					<div class="col-12 col-sm-5 col-md-4 col-lg-4 d-flex justify-content-around align-items-center">
...
<script>
	$(document).ready(function () {
		...
		$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="razonsocial"]').keyup(function (e) {
