        ...
        <div class="card">
          ...
          <div class="card-body">
						...
						<div class="col-12 col-sm-4 col-md-2 col-lg-8 d-flex justify-content-around align-items-center">
							...
							{!! Form::button('<i class="material-icons">add</i>Registrar Repuestos', array('class' => 'btn btn-info p-2 pl-1 pr-1', 'id' => 'btnNuevo', 'onclick' => 'modal (\''.URL::route($ruta["create"], array('listar'=>'SI')).'\', \''.$tituloCheckListVehicular.'\', this);')) !!}
						</div>
						{!! Form::close() !!}
