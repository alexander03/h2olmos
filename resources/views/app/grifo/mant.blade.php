...
<div class="form-group">
	{!! Form::label('abastecimiento', 'lugar de abastecimiento:', array('class' => 'col-lg-12 col-md-12 col-sm-12 control-label')) !!}
	<div class="col-lg-12 col-md-12 col-sm-12">
		{!! Form::text('abastecimiento', null, array('class' => 'form-control input-xs', 'id' => 'abastecimiento')) !!}
	</div>
</div>
<div class="form-group">
