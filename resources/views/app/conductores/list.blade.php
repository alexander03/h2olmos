...
<table id="example1" class="table table-bordered table-striped table-condensed table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>{!! Form::button('<i class="material-icons">assignment</i>', array('onclick' => 'modal (\''.URL::route($ruta["documentos_index"], array($value->id, 'listar'=>'SI')).'\', \''.$titulo_documentos.'\', this);', 'class' => 'btn btn-primary btn-link btn-sm','rel'=>'tooltip','title'=>'Documentos')) !!}</td>
