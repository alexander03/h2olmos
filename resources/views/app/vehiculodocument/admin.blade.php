          ...
          <div>			
			...
			<div class="mt-2 p-2 rounded border border-info d-none" id='content-form-document'>
				...
				{!! Form::open([ 'route' => 'vehiculodocument.store' ,'method' => 'POST' ,'onsubmit' => 'return false;', 'class' => 'form-inline', 'role' => 'form', 'autocomplete' => 'off', 'id' => 'form-document']) !!}
...
<script>
	...
	document.getElementById('document-enviar').addEventListener('click', function(e){
		e.preventDefault();
		let data         = submitForm('#form-document');
