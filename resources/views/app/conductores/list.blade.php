...
<table id="example1" class="table table-bordered table-striped table-condensed table-hover">
	...
	<tbody>
		...
		<tr>
			...
			@else
			<td>{!! Form::button('<i class="material-icons">done</i>', array('onclick' => 'modal (\''.URL::route($ruta["activar"], array($value->id, 'SI')).'\', \''.$titulo_eliminar.'\', this);', 'class' => 'btn btn-success btn-link btn-sm','rel'=>'tooltip','title'=>'Activar')) !!}</td>
			@endif
